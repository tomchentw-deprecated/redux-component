...
describe("React", function () {
  describe("Componentize", function () {
    ...
    describe("(createStore, reducer)", function () {
      it("should create redux store inside the constructor of the ReduxComponent", function () {
        var ReduxComponent = (0, _index.Componentize)(_redux.createStore, function () {
          return {};
        }, noop, noop)();
        var comp = new ReduxComponent();

        (0, _expect2["default"])(comp.store).toBeA("object");
      });
    });
    ...
    describe("(_1, _2, _3, mapDispatchToActions) with render function", function () {
      ...
      context("render", function () {
        it("should pass props and undefined state", function (done) {
          var render = function render(props, state, actions) {
            ...
            (0, _expect2["default"])(state).toBeA("undefined");
            done();
          };
      ...
      it("will clean up Component after unmount", function () {
        ...
        var ReduxComponent = (0, _index.Componentize)(_redux.createStore, function () {
          return {};
        }, noop, mapDispatchToActions)(function () {
          return _react2["default"].createElement("div", null);
        });
