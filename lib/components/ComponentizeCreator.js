    ...
    return function createComponent(_render) {
      ...
      return (function (_Component) {
        ...
        function ReduxComponent() {
          ...
          var dispatch = (0, _createDispatch.createDispatchWithStore)(this, createStore(reducer));

          this.lifecycleActions = _extends({}, NullLifecycleActions, mapDispatchToLifecycle(dispatch));
